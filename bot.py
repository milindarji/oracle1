displayName = 'mdubuntu1'
compartmentId = 'ocid1.tenancy.oc1..aaaaaaaar3l2sgrhl2yw4xh2wyrjbtjkupke7jw6kuxu7yxdio4j6u34xhiq'
availabilityDomain = "eHqj:PHX-AD-1"
bootVolumeId = "ocid1.bootvolume.oc1.phx.abyhqljtz2vnkvzvoxnz5sdhbh55pdey27gdcakwkmhzdb65jqu5advioirq"
subnetId = 'ocid1.subnet.oc1.phx.aaaaaaaacxy5hz5brbraky5jbcobixq45hft42tzg7hpfbpfpdljb3pgeota'
ssh_authorized_keys = "ssh-rsa  imported-openssh-key"
...
instance_detail = oci.core.models.LaunchInstanceDetails(
    ...
    source_details=oci.core.models.InstanceSourceViaImageDetails(
        source_type="bootVolume", image_id=bootVolumeId),
